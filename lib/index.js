...
var LazyList = function (_a) {
    var _b = _a.children, children = _b === void 0 ? [] : _b, _c = _a.tag, tag = _c === void 0 ? 'div' : _c, _d = _a.className, className = _d === void 0 ? '' : _d, _e = _a.renderCount, renderCount = _e === void 0 ? 1 : _e, _f = _a.threshold, threshold = _f === void 0 ? 0 : _f, _g = _a.root, root = _g === void 0 ? null : _g, _h = _a.warpTag, warpTag = _h === void 0 ? 'div' : _h;
    ...
    var cloneChildren = useMemo(function () {
        return children.map(function (item) {
            ...
            var uuid = v4();
            var ele = createElement(type, __assign(__assign({}, props), { key: key || uuid, ref: ref }));
